...
class TestOpenAPIContract:
    ...
    def test_openapi_event_schema_completeness(self):
        ...
        expected_required = ["event_id", "agent_instance_id", "trace_id", "actor", "action_type", "resource", "status"]
    ...
    def test_openapi_enum_definitions(self):
        ...
        assert sorted(action_enum["enum"]) == sorted(
            ["tool_call", "http_request", "db_query", "file_read", "file_write", "api_call", "policy_check"]
        )
...
class TestPydanticValidation:
    ...
    def test_required_fields_enforced(self):
        ...
        required_fields = ["event_id", "agent_instance_id", "trace_id", "actor", "action_type", "resource", "status"]

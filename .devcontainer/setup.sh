...
# Sentinel Dev Container Setup Script
# This runs automatically when the dev container is created

set -e

echo "🛡️  Setting up Sentinel development environment..."
echo ""
...
python -c "from sentinel_audit import AuditClient; print('✅ Sentinel SDK import successful')"
echo ""
...
╔════════════════════════════════════════════════════════════╗
║                                                            ║
║   🛡️  Sentinel Audit - Development Environment Ready!     ║
║                                                            ║
╚════════════════════════════════════════════════════════════╝
